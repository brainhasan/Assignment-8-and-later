...
#TODO: Fill up the contents below in order to reference your assignment 3
...
define AESD_ASSIGNMENTS_BUILD_CMDS
	...
	$(MAKE) USE_AESD_CHAR_DEVICE=1 $(TARGET_CONFIGURE_OPTS) -C $(@D)/server all
endef
#try
...
define AESD_ASSIGNMENTS_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -m 0755 $(@D)/aesd-char-driver/init $(TARGET_DIR)/etc/init.d/S97aesdchar
endef
